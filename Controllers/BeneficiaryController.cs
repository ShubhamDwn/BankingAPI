...
namespace BankingAPI.Controllers
{
    ...
    public class BeneficiariesController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetBeneficiaries([FromQuery] int customerId)
        {
        ...
        // 🔹 DELETE: Mark Beneficiary as Inactive
        [HttpDelete]
        public async Task<IActionResult> DeleteBeneficiary([FromQuery] int customerId, [FromQuery] string accountNumber)
        {
            using var conn = new SqlConnection(_config.GetConnectionString("DefaultConnection"));
            await conn.OpenAsync();
